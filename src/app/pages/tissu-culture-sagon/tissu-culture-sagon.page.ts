...
@Component({
  selector: 'app-tissu-culture-sagon',
  templateUrl: './tissu-culture-sagon.page.html',
  styleUrls: ['./tissu-culture-sagon.page.scss'],
  standalone: true,
...
export class TissuCultureSagonPage implements OnInit {
