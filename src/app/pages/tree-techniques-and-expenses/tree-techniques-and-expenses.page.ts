...
@Component({
  selector: 'app-tree-techniques-and-expenses',
  templateUrl: './tree-techniques-and-expenses.page.html',
  styleUrls: ['./tree-techniques-and-expenses.page.scss'],
  standalone: true,
...
export class TreeTechniquesAndExpensesPage implements OnInit {
