...
@Component({
  selector: 'app-about-yojna',
  templateUrl: './about-yojna.page.html',
  styleUrls: ['./about-yojna.page.scss'],
  standalone: true,
  imports: [IonItem, IonList, IonRow, IonCol, IonLabel, IonGrid, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class AboutYojnaPage implements OnInit {
