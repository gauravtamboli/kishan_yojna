...
var _NgSelectComponent = class _NgSelectComponent {
  ...
  get _validTerm() {
    var _a;
    const term = (_a = this.searchTerm) == null ? void 0 : _a.trim();
  ...
  _setSearchTermFromItems() {
    var _a, _b;
    const selected = (_a = this.selectedItems) == null ? void 0 : _a[0];
    this.searchTerm = (_b = selected == null ? void 0 : selected.label) != null ? _b : null;
  }
  _setItems(items) {
