...
__publicField(_UseStyle, "ɵfac", function UseStyle_Factory(__ngFactoryType__) {
...
__publicField(_BaseStyle, "ɵfac", function BaseStyle_Factory(__ngFactoryType__) {
  ...
  loadCommonTheme() {
    ...
    if (!config_default.isStyleNameLoaded("common")) {
      const {
        ...
        global,
        style
      } = ((_b = (_a = this.baseStyle).getCommonTheme) == null ? void 0 : _b.call(_a)) || {};
      const styleOptions = {
        nonce: (_d = (_c = this.csp) == null ? void 0 : _c.call(this)) == null ? void 0 : _d.nonce
      };
      this.baseStyle.load(primitive == null ? void 0 : primitive.css, __spreadValues({
        name: "primitive-variables"
      }, styleOptions));
      this.baseStyle.load(semantic == null ? void 0 : semantic.css, __spreadValues({
        name: "semantic-variables"
      }, styleOptions));
      this.baseStyle.load(global == null ? void 0 : global.css, __spreadValues({
...
__publicField(_ThemeProvider, "ɵfac", function ThemeProvider_Factory(__ngFactoryType__) {
...
var _BaseComponent = class _BaseComponent {
  ...
  get styleOptions() {
    var _a;
    return {
      nonce: (_a = this.config) == null ? void 0 : _a.csp().nonce
    };
  }
  get _name() {
  ...
  ngAfterViewInit() {
    var _a, _b;
    this.rootEl = (_a = this.el) == null ? void 0 : _a.nativeElement;
    if (this.rootEl) {
      (_b = this.rootEl) == null ? void 0 : _b.setAttribute(this.attrSelector, "");
    }
  }
  ngOnChanges(changes) {
  ...
  _loadCoreStyles() {
    ...
    if (!base.isStyleNameLoaded("base") && this._name) {
      ...
      this.componentStyle && ((_a = this.componentStyle) == null ? void 0 : _a.loadCSS(this.styleOptions));
      base.setLoadedStyleName((_b = this.componentStyle) == null ? void 0 : _b.name);
    }
  }
  _loadThemeStyles() {
    ...
    if (!config_default.isStyleNameLoaded("common")) {
      const {
        ...
        global,
        style
      } = ((_b = (_a = this.componentStyle) == null ? void 0 : _a.getCommonTheme) == null ? void 0 : _b.call(_a)) || {};
      this.baseStyle.load(primitive == null ? void 0 : primitive.css, __spreadValues({
        name: "primitive-variables"
      }, this.styleOptions));
      this.baseStyle.load(semantic == null ? void 0 : semantic.css, __spreadValues({
    ...
    if (!config_default.isStyleNameLoaded((_c = this.componentStyle) == null ? void 0 : _c.name) && ((_d = this.componentStyle) == null ? void 0 : _d.name)) {
      const {
        css: css3,
        style
      } = ((_f = (_e = this.componentStyle) == null ? void 0 : _e.getComponentTheme) == null ? void 0 : _f.call(_e)) || {};
      (_h = this.componentStyle) == null ? void 0 : _h.load(css3, __spreadValues({
        name: `${(_g = this.componentStyle) == null ? void 0 : _g.name}-variables`
      }, this.styleOptions));
      (_j = this.componentStyle) == null ? void 0 : _j.loadTheme(__spreadValues({
        name: `${(_i = this.componentStyle) == null ? void 0 : _i.name}-style`
      }, this.styleOptions), style);
      config_default.setLoadedStyleName((_k = this.componentStyle) == null ? void 0 : _k.name);
    }
    if (!config_default.isStyleNameLoaded("layer-order")) {
      const layerOrder = (_m = (_l = this.componentStyle) == null ? void 0 : _l.getLayerOrderThemeCSS) == null ? void 0 : _m.call(_l);
  ...
  _loadScopedThemeStyles(preset) {
    ...
    const {
      css: css3
    } = ((_b = (_a = this.componentStyle) == null ? void 0 : _a.getPresetTheme) == null ? void 0 : _b.call(_a, preset, `[${this.attrSelector}]`)) || {};
    const scopedStyle = (_d = this.componentStyle) == null ? void 0 : _d.load(css3, __spreadValues({
      name: `${this.attrSelector}-${(_c = this.componentStyle) == null ? void 0 : _c.name}`
    }, this.styleOptions));
    this.scopedStyleEl = scopedStyle == null ? void 0 : scopedStyle.el;
  }
  _unloadScopedThemeStyles() {
    var _a;
    (_a = this.scopedStyleEl) == null ? void 0 : _a.remove();
  }
  ...
  cx(arg, rest) {
    var _a, _b, _c, _d;
    const classes = this.parent ? (_b = (_a = this.parent.componentStyle) == null ? void 0 : _a.classes) == null ? void 0 : _b[arg] : (_d = (_c = this.componentStyle) == null ? void 0 : _c.classes) == null ? void 0 : _d[arg];
  ...
  sx(arg) {
    var _a, _b;
    const styles = (_b = (_a = this.componentStyle) == null ? void 0 : _a.inlineStyles) == null ? void 0 : _b[arg];
...
__publicField(_BaseComponent, "ɵfac", function BaseComponent_Factory(__ngFactoryType__) {
...
var _Scroller = class _Scroller extends BaseComponent {
  ...
  viewInit() {
    ...
    if (isPlatformBrowser(this.platformId) && !this.initialized) {
      if (isVisible((_a = this.elementViewChild) == null ? void 0 : _a.nativeElement)) {
        this.setInitialState();
        this.setContentEl(this.contentEl);
        this.init();
        this.defaultWidth = getWidth((_b = this.elementViewChild) == null ? void 0 : _b.nativeElement);
        this.defaultHeight = getHeight((_c = this.elementViewChild) == null ? void 0 : _c.nativeElement);
  ...
  setContentEl(el) {
    var _a, _b;
    this.contentEl = el || ((_a = this.contentViewChild) == null ? void 0 : _a.nativeElement) || findSingle((_b = this.elementViewChild) == null ? void 0 : _b.nativeElement, ".p-virtualscroller-content");
  }
  setInitialState() {
  ...
  onWindowResize() {
    ...
    this.resizeTimeout = setTimeout(() => {
      var _a, _b, _c;
      if (isVisible((_a = this.elementViewChild) == null ? void 0 : _a.nativeElement)) {
        const [width, height] = [getWidth((_b = this.elementViewChild) == null ? void 0 : _b.nativeElement), getHeight((_c = this.elementViewChild) == null ? void 0 : _c.nativeElement)];
...
//# sourceMappingURL=chunk-SKNVNBQ2.js.map
