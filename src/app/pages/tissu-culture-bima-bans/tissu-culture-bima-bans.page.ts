...
@Component({
  selector: 'app-tissu-culture-bima-bans',
  templateUrl: './tissu-culture-bima-bans.page.html',
  styleUrls: ['./tissu-culture-bima-bans.page.scss'],
  standalone: true,
...
export class TissuCultureBimaBansPage implements OnInit {
